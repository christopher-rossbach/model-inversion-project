...
\begin{table*}[ht]
    \centering
        ...
        \caption{
            ...
            The differences, shown in brackets, are calculated with respect to the same backbone and $y_h$ calculation method so that only the effect of the removal of the ReLU is shown.
...
\begin{table*}[ht]
    \centering
        \input{figures/experiments_in_vs_ffhq}
        \caption{
        ...
        The numbers in brackets indicate the difference to the corresponding improvement when reconstructing images from the ImageNet validation set.
        }
...
\begin{table*}[ht]
    \centering
        \input{figures/experiments_best_rows_table}
        \caption{
            Comparison of reconstruction quality for the best parametrizations for each architecture.
